...
module.exports = function (_a) {
    var admin = _a.admin, environment = _a.environment;
    return function (change, context) { return __awaiter(_this, void 0, void 0, function () {
        var db, projectId, accountId, newDoc, oldDoc;
        return __generator(this, function (_a) {
            db = admin.firestore();
            projectId = context.params.projectId;
            accountId = context.params.accountId;
            newDoc = change.after.exists ? change.after.data() : null;
