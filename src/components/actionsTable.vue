        ...
        >
          <q-menu max-width="370px" anchor="center right" self="center left">
            <q-list separator class="q-px-sm">
              <q-item>
                <q-item-section>
                  <q-item-label header class="text-bold">Actions</q-item-label>
                  <q-item-label caption>
                    ...
                    <br />
                    When choosing which Action to record, consider any money in
                    the hands of Missionaries and Project Participants as
              ...
              >
                <q-card>
                  <q-card-section>
                    ...
                    and Budgets without leaving the Project and are recorded in
                    blue.
                  </q-card-section>
                </q-card>
              </q-expansion-item>
                ...
                <q-card>
                  <q-card-section>
                    ...
                    <ul>
                      ...
                      <li>
                        Category - The Category connected to the relevant Budget
                        (Auto Generated)
                      </li>
                      <li>
                      ...
                      <li>
                        Date - The date that the Action took place, for expense
                        Actions this will be recorded on the Tax Invoice
                      </li>
                      ...
                      <li>
                        Paid To - The supplier/business who the Action was made
                        to (Expenses only)
                      </li>
                      <li>
              ...
              <q-expansion-item expand-separator label="Processing & Reviewing">
                <q-card>
                  <q-card-section>
                    Each time you/or someone else submits a Action, you need to
                    review it. Once you have checked that all of the details for
                    the Action are correct, click the 'Reviewed?' button. This
                    will lock the Action and prevent Contributors from editing
                    this Action. At the end of the Summer Project all Actions
                    should have been checked and marked as 'Reviewed!'. Use the
      ...
      <q-tr :props="props" class="text-bold">
        ...
        <q-td key="desc" :props="props">
          ...
          <div class="text-caption">
            {{
              props.row.type === 'reimbursement' &&
              users[props.row.responsiblePerson]
                ? users[props.row.responsiblePerson].name
                  ? `(${users[props.row.responsiblePerson].name})`
                  : `(${users[props.row.responsiblePerson].email})`
                : ''
            }}
          </div>
        </q-td>
        <q-td key="complete" :props="props" auto-width>
          <q-avatar
            :icon="props.row.complete ? 'check' : 'highlight_off'"
            round
        ...
        <q-dialog
          ...
          maximised
        >
          <petty-cash v-if="props.row.type === 'petty'" :action="props.row" />
          <cash-in-hand
...
export default {
  ...
  setup() {
    ...
    const pagination = ref(
      q.localStorage.has('actionsPagination')
