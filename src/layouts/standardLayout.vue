              ...
              <div class="q-gutter-xs">
                ...
                >
                  ...
                  <q-btn
                    ...
                    size="xs"
                    icon="close"
                    @click="removeNewInviteBudget(budget)"
                  />
                </q-badge>
              </div>
            </q-card-section>
            ...
            <q-card-section style="max-height: 40vh;" class="scroll">
              <q-list separator>
                ...
                <div class="text-subtitle2" v-if="contributors.length > 0">
                  Contributors
                  <q-tooltip content-class="bg-accent text-grey-10">
                    Contributors can submit receipts and transactions for the
                    Budgets they have access to
                  </q-tooltip>
                </div>
                <q-item
                ...
                >
                  ...
                  <q-item-section clickable class="q-gutter-xs q-pr-lg">
                    ...
                    <q-badge
                      color="blue"
                      v-for="budget in member.budgets"
                      :key="'budget-' + budget"
                    >
                      {{
                        budgets[budget]
              ...
              <q-card-section v-if="invites.length > 0">
                ...
                >
                  ...
                  <q-item-section
                    clickable
                    v-if="member.permission === 'contributor'"
                  >
                    <q-select
                      :options="budgetOptions"
                      dense
                      ...
                      style="min-width:100px"
                      @input="
                        addInviteBudget(member.budgets, $event.id, member.email)
                      "
                      value=""
                    />
                    <q-badge
                  ...
                  <q-item-section side>
                    <q-btn
                      ...
                      icon="delete"
                      color="negative"
                      @click="removeInvite(member.email)"
                    />
                  </q-item-section>
                </q-item>
              </q-list>
