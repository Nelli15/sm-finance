    ...
    >
      <template v-slot:top="props">
        <div class="col-4 q-table__title">
          My Transactions{{ pageLabel > '' ? ' for ' + pageLabel : '' }}
        </div>
      ...
      if (this.$route.params.budgetCategory) {
          ...
          for (var transKey in this.myTransactions) {
            ...
            if (
              ...
              if (
                (this.$route.params.budgetCategory ===
                  this.myTransactions[transKey].budget &&
                  this.myTransactions[transKey].category !== 'Journal') ||
                (this.$route.params.budgetCategory ===
                  this.myTransactions[transKey].to &&
                  this.myTransactions[transKey].category === 'Journal') ||
                (this.$route.params.budgetCategory ===
        ...
        for (transKey in this.myTransactions) {
          ...
          if (
            ...
            if (
              (budgets.includes(this.myTransactions[transKey].budget) &&
                this.myTransactions[transKey].category !== 'Journal') ||
              (budgets.includes(this.myTransactions[transKey].to) &&
                this.myTransactions[transKey].category === 'Journal') ||
              (budgets.includes(this.myTransactions[transKey].from) &&
                this.myTransactions[transKey].category === 'Journal')
            ) {
              // add the myTransactions to the transaction array
              myTransactions.push(this.myTransactions[transKey])
